...
class Calendario extends View
{
    ...
    public function __construct(Datetime $desde,Datetime $hasta=null, $agregar_padding=true)
    {
        ...
        parent::__construct();
        if(self::ACTIVAR_DEBUG) Logger::developper('Creando calendario vacio.');
