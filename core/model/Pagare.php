...
class Pagare extends Model {
    ...
    public static function select_pagares_prestamo($variables) {
        $array[] = $variables['id'];
        $sql = "select id_pagare,id_prestamo,fecha_vto, round(monto,2) as cuota , nro_cuota,id_estado from pagare where id_prestamo=?";
